...
// cuando se hace clic en filtrar (ya sea por género o todos) dejan de funcionar los botones de agregar carrito, pero cuando se ven todos los libros al abrir la página (sin filtrar) funciona bien. Creo que tiene que ver con algo del DOM y con que todavía no existen los botones cuando se les quiere dar una funcionalidad, no lo sé. Me rendí después de muchos días de romperme la cabeza intentando entenderlo y arreglarlo.
...
// para este cartel intenté generar un for con un contador hasta 1 y guardandolo en el storage para que solamente aparezca solamente la primera vez que el usuario entra a la web y no siempre, pero no me salió la parte del storage.
